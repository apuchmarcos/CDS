...
const (
	Agent_GetVersion_FullMethodName = "/cds.Agent/GetVersion"
)
...
type AgentClient interface {
	// GetVersion returns the version of the API server.
...
func (c *agentClient) GetVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Version, error) {
	...
	out := new(Version)
	err := c.cc.Invoke(ctx, Agent_GetVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Agent_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_GetVersion_FullMethodName,
	}
...
var Agent_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/api/v1/cds.proto",
}
